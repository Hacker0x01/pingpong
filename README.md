...
### Promoting Diversity
Diversity at HackerOne is a hot topic. We aim to be as diverse as possible. Not only when working on world-class product, but also during teambuilding. Therefore any diverse playing member (women, foreigners, visitors from SF) will start any round with one life. That excludes players who own Frisian passport, and players from Brabant.
